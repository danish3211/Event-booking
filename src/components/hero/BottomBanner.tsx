  ...
  return (
    <section className="flex flex-col">
      ...
      <div className="relative w-full py-20 lg:py-32 overflow-hidden">
        <div className="absolute top-[-20%] right-[-10%] w-[400px] h-[400px] rounded-full bg-vivid/40 blur-[120px]" />
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left lg:pl-10">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-background leading-[1.1]">
              Discover Events.<br />
              <span className="text-primary italic">Anywhere, Anytime.</span>
            </h2>
            <p className="text-lg md:text-xl text-background/60 leading-relaxed max-w-lg mx-auto lg:mx-0">
